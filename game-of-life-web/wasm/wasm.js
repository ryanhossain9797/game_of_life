...
export class Life {
    ...
    /**
     * @param {WasmPoint[]} initial
     * @param {number} width
     * @param {number} height
     */
    constructor(initial, width, height) {
        const ptr0 = passArrayJsValueToWasm0(initial, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.life_new(ptr0, len0, width, height);
     ...
     */
    tick() {
        const ret = wasm.life_tick(this.__wbg_ptr);
...
export class WasmPoint {
    static __unwrap(jsValue) {
        if (!(jsValue instanceof WasmPoint)) {
            return 0;
        }
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_wasmpoint_unwrap: function(arg0) {
            const ret = WasmPoint.__unwrap(arg0);
            return ret;
        },
...
const LifeFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_life_free(ptr >>> 0, 1));
